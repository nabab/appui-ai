...
<div style="height: auto; max-width: 70%; width: 100%"
     :class="'appui-prompt-item bbn-xsmargin bbn-flex-column bbn-radius bbn-bottom-smargin ' + (source.ai ? 'flex-end bbn-secondary' : 'flex-start bbn-primary')">
